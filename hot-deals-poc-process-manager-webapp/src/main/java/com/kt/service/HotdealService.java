...
public class HotdealService extends AbstractService {
	 ...
	 */
	public DefaultResponse getHotdealEvent(String eventId, String phoneNum) {
		String name = hotdealDao.getEventFcfs(eventId, phoneNum);
	...
	public DefaultResponse setHotdealEvent(Integer eventType, HotdealRequest params) {
		...
		if (isCreate) { // 신규 등록
			...
			event.setPhoneNum(params.getPhoneNum());
